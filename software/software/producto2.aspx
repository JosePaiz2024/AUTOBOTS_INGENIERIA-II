<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="producto2.aspx.cs" Inherits="software.producto2" %>
...
<div class="info">
    ...
    <p>  </p>
    <br />
    <p class="precio">USD $15</p>
    <br />
    <p class="explica">
        Ampolleta de freno universal
    </p>
    <br />
