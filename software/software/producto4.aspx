<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="producto4.aspx.cs" Inherits="software.producto4" %>
...
<div class="info">
    ...
    <h2>&nbsp;</h2>
    <h2>&nbsp;</h2>
    <h2>Bomba de freno</h2>
    <p>  </p>
    <br />
    <p class="precio">USD $115</p>
    <br />
    <p class="explica">
        Bomba de freno, motor 2rz
    </p>
    <br />
