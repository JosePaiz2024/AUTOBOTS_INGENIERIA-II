<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="producto6.aspx.cs" Inherits="software.producto6" %>
...
<div class="info">
    ...
    <p>  </p>
    <br />
    <p class="precio">USD $75</p>
    <br />
    <p class="explica">
        Kit de distibucion, motor l20b
    </p>
    <br />
